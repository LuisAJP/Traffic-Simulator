...
public class MapaCarreteras {
	...
	public String generateReport(int time) {
		...
		//informeString =/* informeString +*/ report;
		//informeString = informeString + report;
		return report;
	}
	...
	public LinkedList<CruceGenerico<?>> getCruces() {
		return this.cruces;
	}
	...
	/*public String getInformeString() {
		return this.informeString;
	}*/
	
	/*public void setInformeString(){
		this.informeString="";
